...
GUARD_VERSION = "cogs.stage2-static-control-dispatch-guard/v24"
...
REJECTED_BRANCH_PREDECESSOR_RUN_TITLE = (
    "Non-authoritative Stage 2 static control "
    "H=dfb28c2e8deb7fed90da095c41b4d556c737af97")
...
SECOND_SUCCESSFUL_PREDECESSOR_RUN_ID = 32590966571
SECOND_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "acb99d5d6ba4cbd94ad40c9bbe4520d2f8905368"
SECOND_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD = "33314a9999cbe1e0eb927ba4a1e6f1ee10fcd5df"
SECOND_SUCCESSFUL_PREDECESSOR_RUN_TITLE = (
    f"Non-authoritative Stage 2 static control H={SECOND_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD}")
THIRD_SUCCESSFUL_PREDECESSOR_RUN_ID = 32594176203
THIRD_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "7759346c281b45a3d98476abdfaa820109601547"
THIRD_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD = "a2c25f34c35d778965ab7b125fd3b8b4460b0617"
THIRD_SUCCESSFUL_PREDECESSOR_RUN_TITLE = (
    f"Non-authoritative Stage 2 static control H={THIRD_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD}")
FOURTH_SUCCESSFUL_PREDECESSOR_RUN_ID = 32600501461
FOURTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "e9e4ea6aef35c9d4cb821e2fcc6adf480eec87f3"
FOURTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD = "1eaec52dd4e2f1222548362e92adc780a2169025"
FOURTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE = (
    f"Non-authoritative Stage 2 static control H={FOURTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD}")
FIFTH_SUCCESSFUL_PREDECESSOR_RUN_ID = 32620087277
FIFTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "0c4c698ed7c8a4d28f350293102012a1dd9d869c"
FIFTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD = "4bced3fb4b768f5dc67f919ae8d579059739b126"
FIFTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE = (
    f"Non-authoritative Stage 2 static control H={FIFTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD}")
SIXTH_SUCCESSFUL_PREDECESSOR_RUN_ID = 32627151171
SIXTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "aee6966c2977258d310affa0c3b63d0863d090fd"
...
EIGHTH_SUCCESSFUL_PREDECESSOR_RUN_ID = 33290514426
EIGHTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "b6a6f4613ded73d0496602eb5dd9b5db7520e04a"
EIGHTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD = "89243c8d9f7a946aefdaa4c445a5cfe1e0fe7e14"
EIGHTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE = (
    f"Non-authoritative Stage 2 static control H={EIGHTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD}")
NINTH_SUCCESSFUL_PREDECESSOR_RUN_ID = 33320343092
NINTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD = "73a5067bdc4ea6941097651beb00ebcc78e2dd9b"
NINTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD = "bf0479a012b39c074ecb623ea83e85b3dc3ebe36"
NINTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE = (
    f"Non-authoritative Stage 2 static control H={NINTH_SUCCESSFUL_PREDECESSOR_REVIEWED_HEAD}")
PREDECESSORS = {
...
SUCCESSFUL_PREDECESSORS = {
    ...
    SECOND_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        SECOND_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD,
        SECOND_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
    THIRD_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        THIRD_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD,
        THIRD_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
    FOURTH_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        FOURTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD,
        FOURTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
    FIFTH_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        FIFTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD,
        FIFTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
    ...
    SEVENTH_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        ...
        SEVENTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
    EIGHTH_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        EIGHTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD,
        EIGHTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
    NINTH_SUCCESSFUL_PREDECESSOR_RUN_ID: (
        NINTH_SUCCESSFUL_PREDECESSOR_WORKFLOW_HEAD,
        NINTH_SUCCESSFUL_PREDECESSOR_RUN_TITLE),
}
...
def guard(environ=os.environ, urlopen=_authenticated_open):
    ...
    _require(workflow_head not in ({value[0] for value in PREDECESSORS.values()}
                                   | {value[0] for value in SUCCESSFUL_PREDECESSORS.values()}),
             "IDENTITY_REJECTED")
