...
const shellFiles = [
  ...
  "recover-production-campaign-entry.sh",
...
const pythonFiles = [
  ...
  "completion_campaign_aws_entry.py",
  "completion_campaign_aws_provider.py",
  "completion_campaign_aws_recovery_entry.py",
  ...
  "completion_campaign_evidence_issuer.py",
