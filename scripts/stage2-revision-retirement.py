...
POLICY_V7 = Path(__file__).resolve().parents[1] / "config/stage2-retired-revisions-v7.json"
POLICY = Path(__file__).resolve().parents[1] / "config/stage2-retired-revisions-v8.json"
...
POLICY_V7_SHA256 = "d0d74eab6a47062db91a1e0e45aa1fae102614a3f5253253450bb11336c96d1c"
REVISIONS_V1 = {
...
REVISIONS_V7 = {**REVISIONS_V6, **{value: "ADR0364" for value in ("8e9328c66a1ab930583e22f07ba6f17f23bc7d2e", "f82c9e77acbd8cf1f963a46d73a9e70afb6f41d6", "6d2eff8ffa8fe525b5566a0ddded7d79e868ba16", "c075458cf2d853200df57584c1b16cf38bd6e38c", "f75d3f09990de4635cc3890efe0f5f6e783312bd")}}
RUNS_V7 = {**RUNS_V6, **{value: "ADR0364" for value in ("35928408355", "35938320143", "35938533499", "35946454149")}}
ARTIFACTS_V7 = {**ARTIFACTS_V6, **{value: "ADR0364" for value in ("10780807449", "10783357865", "10784336353")}}
REVISIONS = {**REVISIONS_V7, "56fdd694c1a0c6967bf09156d44260f18a28888d": "ADR0365"}
RUNS = {**RUNS_V7, "35957236430": "ADR0365"}
ARTIFACTS = {**ARTIFACTS_V7, "10791707159": "ADR0365"}
...
def load_policy(path=POLICY):
    ...
    predecessor_v7, predecessor_v7_raw = document(POLICY_V7, 16384)
    require(hashlib.sha256(predecessor_v7_raw).hexdigest() == POLICY_V7_SHA256 and predecessor_v7 == {"version": "cogs.stage2-retired-revisions/v7", "predecessor": {"version": predecessor_v6["version"], "sha256": POLICY_V6_SHA256}, "revisions": REVISIONS_V7, "runs": RUNS_V7, "artifacts": ARTIFACTS_V7})
    value, _raw = document(path, 16384)
    require(value == {"version": "cogs.stage2-retired-revisions/v8",
                      "predecessor": {"version": predecessor_v7["version"],
                                      "sha256": POLICY_V7_SHA256},
