...
H=2076c2bd781a663d2b27fa478792fc133fa9fd42
G=1956ea8da439de2ae137e6ccbc5650ca149fe815
MANIFEST=f4f4fee0eea79315a7079240a1df0a90e7da52adf3189e33d0326cf5339dbc2a
CONTROL=b2a4475e9277640dea97dc1d9fcc69eeb9af44175ae9f83faf05ed482e5fa01a
DESCRIPTOR=0ac75bf044aa20fc1b1047a5c0579b6489c1ec19502c0044061a5e1fd1597c2c
...
admit() {
  ...
  test "$EXACT_IMPLEMENTATION_HEAD" = "$CONFIGURED_IMPLEMENTATION_HEAD" || return
  test "$EXACT_CONTROL_HEAD" = "$CONFIGURED_CONTROL_HEAD" || return
  test "$EXACT_QUALIFICATION_HEAD" = "$CONFIGURED_QUALIFICATION_HEAD" || return
  test "$GITHUB_ACTOR" = "$CONFIGURED_AUTHORIZED_ACTOR" || return
  test "$GITHUB_TRIGGERING_ACTOR" = "$CONFIGURED_AUTHORIZED_ACTOR" || return
