...
PRODUCT_TEST_REMAINING_LINES, PRODUCT_TEST_REMAINING_BYTES = 15_127, 15_000_000
PRODUCT_TEST_FORECASTS = dict(route=0, revocation=0, relay=1_400, lifecycle=1_000, completion=0, integration=12_727)
...
def _remediation_budget():
    ...
    _require(data["version"] == "cogs.external-review-remediation-budget/v1"
             ...
             and data["global_gross_line_high"] == 63_127 and type(data["global_gross_byte_high"]) is int and data["global_gross_byte_high"] == REMEDIATION_GLOBAL_BYTE_HIGH)
    ...
    _require(data["source_limits"] == {"tracked_files": 1620,
                                        "source_inventory_bytes": 45_000_000,
