...
PRODUCT_TEST_FINAL_HGQ_POST_H_CAP = (900, 3_500_000)
...
def _product_test_budget(data, _allocations):
    """Validate the deliberately small ADR0338–ADR0345 task matrix.
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 607, "gross_bytes": 1700000}
                     and task["post_h_reserve"] == {"gross_lines": 900, "gross_bytes": 3500000}
...
def measure():
    ...
    _require(tracked_names | ordinary_names == retained_names
             and ordinary_names <= set((*ADR0327_RETAINED_FILES, *ADR0330_RETAINED_FILES, *ADR0349_RETAINED_FILES, *ADR0353_RETAINED_FILES)))
