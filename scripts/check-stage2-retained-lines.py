...
PRODUCT_TEST_TASK_SPECS = (
    ...
    ('local-tofu-ssm', 4457, 3300000, ('.github/workflows/stage2-production-approval-signing-diagnostic.yml', '.github/workflows/stage2-production-approval.yml', '.github/workflows/stage2-production-campaign.yml', '.github/workflows/stage2-r-diagnostic-campaign.yml', '.github/workflows/stage2-r-diagnostic-preparation.yml', 'deploy/aws-feasibility/completion_campaign_aws_adapter.py', 'deploy/aws-feasibility/completion_campaign_aws_entry.py', 'deploy/aws-feasibility/completion_campaign_aws_provider.py', 'deploy/aws-feasibility/completion_campaign_controller.py', 'deploy/aws-feasibility/completion_campaign_production.py', 'deploy/aws-feasibility/destroy.sh', 'deploy/aws-feasibility/run-production-campaign.sh', 'schemas/aws-stage2-completion-evidence-v3.json', 'schemas/aws-stage2-completion-production-approval-v5.json', 'scripts/stage2-cosign-keyless-sign.sh', 'scripts/stage2-production-planner.py', 'scripts/stage2-stage-production-approval.py', 'test/aws-stage2-completion-campaign-aws-adapter.test.ts', 'test/aws-stage2-completion-campaign-aws-provider.py', 'test/aws-stage2-completion-campaign-aws-provider.test.ts', 'test/aws-stage2-completion-campaign-production.py', 'test/aws-stage2-completion-campaign-production.test.ts', 'test/aws-stage2-completion-campaign-remote-adapter.py', 'test/fixtures/stage2-completion/approval-v5-test-only.json', 'test/stage2-production-approval.py', 'test/stage2-production-approval.test.ts', 'test/stage2-production-planner.py', 'test/stage2-production-planner.test.ts', 'test/stage2-production-workflows.test.ts')),
...
def _remediation_budget():
    ...
    _require(data["source_limits"] == {"tracked_files": 1546,
    ...
    try:
        ...
        raise LineBudgetError() from None
    _require("MAXIMUM_TRACKED_FILES = 1546" in producer
