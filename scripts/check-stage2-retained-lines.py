...
PRODUCT_TEST_REMAINING_LINES, PRODUCT_TEST_REMAINING_BYTES = 23_950, 21_500_000
PRODUCT_TEST_GLOBAL_LINE_FORECAST, PRODUCT_TEST_GLOBAL_BYTE_FORECAST = 41_950, 29_500_000
...
PRODUCT_TEST_FINAL_HGQ_POST_H_CAP = (3_405, 3_500_000)
...
def _remediation_budget():
    ...
    _require(data["source_limits"] == {"tracked_files": 1564,
    ...
    try:
        ...
        raise LineBudgetError() from None
    _require("MAXIMUM_TRACKED_FILES = 1564" in producer
...
def _product_test_budget(data, _allocations):
    """Validate the deliberately small ADR0338–ADR0363 task matrix.
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 604, "gross_bytes": 1700000}
                     and task["post_h_reserve"] == {"gross_lines": 3405, "gross_bytes": 3500000}
