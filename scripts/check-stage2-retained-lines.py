...
PRODUCT_TEST_FINAL_HGQ_PRE_H_CAP = (607, 1_700_000)
PRODUCT_TEST_FINAL_HGQ_POST_H_CAP = (3_150, 3_500_000)
...
def _product_test_budget(data, _allocations):
    """Validate the deliberately small ADR0338–ADR0362 task matrix.
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        seen.update(paths)
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 607, "gross_bytes": 1700000}
                     and task["post_h_reserve"] == {"gross_lines": 3150, "gross_bytes": 3500000}
