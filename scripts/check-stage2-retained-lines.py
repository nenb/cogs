...
PRODUCT_TEST_PRE_H_TASK_MAXIMA['final-HGQ'] = (707, 1700000)
PRODUCT_TEST_FINAL_HGQ_MINIMUM = (1200, 3500000)
...
def _product_test_budget(data, _allocations):
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        seen.update(paths)
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 707, "gross_bytes": 1700000}
                     and task["post_h_reserve"] == {"gross_lines": 1200, "gross_bytes": 3500000}
