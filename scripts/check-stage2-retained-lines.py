...
PRODUCT_TEST_TASK_SPECS = (
    ...
    ('product', 4000, 3200000, ('.github/workflows/insecure-container.yml', '.github/workflows/kvm-qualification.yml', 'dev/linux-kvm/driver.sh', 'dev/linux-kvm/bounded-command.py', 'dev/linux-kvm/qualification-owner.py', 'dev/linux-kvm/qualify.sh', 'dev/product-test/host-custody.py', 'dev/product-test/runner.ts', 'dev/product-test/snapshot-owner.ts', 'docs/adr/0337-correct-protected-product-runtime-ancestry.md', 'images/sandbox/entrypoint.sh', 'src/egress/otlp-telemetry.ts', 'src/ssh/connection.ts', 'src/telemetry/worker-telemetry.ts', 'test/egress-otlp-telemetry.test.ts', 'test/linux-kvm-git-tools.test.ts', 'test/ssh-connection.test.ts', 'test/worker-telemetry.test.ts', 'test/dev-launcher-profiles.test.ts', 'test/production-compose.test.ts', 'test/production-sandbox-image.test.ts')),
