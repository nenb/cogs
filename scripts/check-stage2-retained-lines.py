...
PRODUCT_TEST_PRE_H_TASK_MAXIMA['final-HGQ'] = (621, 1700000)
...
def _product_test_budget(data, _allocations):
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        seen.update(paths)
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 621, "gross_bytes": 1700000}
