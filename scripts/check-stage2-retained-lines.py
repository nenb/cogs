...
def _remediation_budget():
    ...
    _require(data["source_limits"] == {"tracked_files": 1559,
    ...
    try:
        ...
        raise LineBudgetError() from None
    _require("MAXIMUM_TRACKED_FILES = 1559" in producer
...
def measure():
    ...
    _require(tracked_names | ordinary_names == retained_names
             and ordinary_names <= set((*ADR0327_RETAINED_FILES, *ADR0330_RETAINED_FILES, *ADR0349_RETAINED_FILES)))
