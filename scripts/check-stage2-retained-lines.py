...
PRODUCT_TEST_REMAINING_LINES, PRODUCT_TEST_REMAINING_BYTES = 22_157, 21_500_000
PRODUCT_TEST_GLOBAL_LINE_FORECAST, PRODUCT_TEST_GLOBAL_BYTE_FORECAST = 40_157, 29_500_000
...
PRODUCT_TEST_FINAL_HGQ_POST_H_CAP = (1_500, 3_500_000)
...
def _product_test_budget(data, _allocations):
    """Validate the deliberately small ADR0338–ADR0357 task matrix.
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 607, "gross_bytes": 1700000}
                     and task["post_h_reserve"] == {"gross_lines": 1500, "gross_bytes": 3500000}
