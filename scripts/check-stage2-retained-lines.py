...
AWS_INGRESS_INVENTORY = {'planner_cli': ('scripts/stage2-production-planner.py',), 'approval_and_staging_front_doors': ('scripts/stage2-production-approval.py', 'scripts/stage2-stage-production-approval.py'), 'aws_entry_and_recovery': ('deploy/aws-feasibility/check-plan.py', 'deploy/aws-feasibility/completion_campaign_aws_adapter.py', 'deploy/aws-feasibility/completion_campaign_aws_entry.py', 'deploy/aws-feasibility/completion_campaign_aws_provider.py', 'deploy/aws-feasibility/completion_campaign_aws_recovery_entry.py', 'deploy/aws-feasibility/completion_campaign_controller.py', 'deploy/aws-feasibility/completion_campaign_production.py', 'deploy/aws-feasibility/completion_campaign_remote_adapter.py', 'deploy/aws-feasibility/completion_campaign_state.py'), 'cycle_and_grant_consumers': ('deploy/aws-feasibility/remote/completion_cycle_authority.py', 'deploy/aws-feasibility/remote/completion_cycle_full.py', 'deploy/aws-feasibility/remote/completion_cycle_full_diagnostic.py', 'deploy/aws-feasibility/remote/completion_cycle_full_rehearsal.py', 'deploy/aws-feasibility/remote/completion_cycle_readiness.py', 'deploy/aws-feasibility/remote/completion_cycle_readiness_diagnostic.py', 'deploy/aws-feasibility/remote/completion_cycle_readiness_rehearsal.py', 'deploy/aws-feasibility/remote/completion_formal_cycle_authority.py', 'deploy/aws-feasibility/remote/completion_formal_cycle_full.py', 'deploy/aws-feasibility/remote/completion_formal_cycle_readiness.py', 'deploy/aws-feasibility/remote/completion_kata_coordinator.py'), 'local_executable_front_doors': ('deploy/aws-feasibility/remote/completion_kata_diagnostic_control.py', 'deploy/aws-feasibility/remote/completion_kata_immutable_preparation.py', 'deploy/aws-feasibility/remote/completion_kata_nft_owner.py', 'deploy/aws-feasibility/remote/completion_kata_preparation.py', 'deploy/aws-feasibility/remote/completion_kata_qualification.py', 'deploy/aws-feasibility/remote/completion_local_full.py', 'deploy/aws-feasibility/remote/completion_package_candidate.py', 'deploy/aws-feasibility/remote/completion_package_candidate_recovery.py', 'deploy/aws-feasibility/remote/completion_package_post_pin_recovery.py', 'deploy/aws-feasibility/remote/completion_rootfs_builder.py', 'deploy/aws-feasibility/remote/completion_rootfs_plan.py', 'deploy/aws-feasibility/remote/completion_trusted_runtime_launcher.py'), 'legacy_shell_effect_routes': ('deploy/aws-feasibility/apply.sh', 'deploy/aws-feasibility/destroy.sh', 'deploy/aws-feasibility/inventory.sh', 'deploy/aws-feasibility/plan.sh', 'deploy/aws-feasibility/recover-production-campaign-entry.sh', 'deploy/aws-feasibility/recover-production-campaign.sh', 'deploy/aws-feasibility/remote/measure-runtime.sh', 'deploy/aws-feasibility/remote/recover-stage2-completion-remote.sh', 'deploy/aws-feasibility/remote/run-stage2-completion-full-rehearsal.sh', 'deploy/aws-feasibility/remote/run-stage2-completion-full.sh', 'deploy/aws-feasibility/remote/run-stage2-completion-readiness-rehearsal.sh', 'deploy/aws-feasibility/remote/run-stage2-completion-readiness.sh', 'deploy/aws-feasibility/remote/run-stage2-completion-remote.sh', 'deploy/aws-feasibility/remote/validate-runtime.sh', 'deploy/aws-feasibility/run-measurement-campaign.sh', 'deploy/aws-feasibility/run-measurement-validation.sh', 'deploy/aws-feasibility/run-production-campaign.sh', 'deploy/aws-feasibility/run-production-effect.sh', 'deploy/aws-feasibility/run-production-inventory.sh', 'deploy/aws-feasibility/run-production-remote.sh', 'deploy/aws-feasibility/run-runtime-validation.sh', 'deploy/aws-feasibility/validate.sh'), 'decode_only': ('deploy/aws-feasibility/completion_campaign_codec.py', 'deploy/aws-feasibility/completion_campaign_contracts.py', 'deploy/aws-feasibility/completion_campaign_receipts.py', 'deploy/aws-feasibility/remote/verify-completion-artifacts.py')}
AWS_BUDGET_CONSUMERS = ('deploy/aws-feasibility/main.tf', 'deploy/aws-feasibility/variables.tf', 'deploy/aws-feasibility/outputs.tf', 'deploy/aws-feasibility/completion_campaign_controller.py', 'deploy/aws-feasibility/completion_campaign_aws_provider.py', 'deploy/aws-feasibility/completion_campaign_production.py', 'deploy/aws-feasibility/completion_campaign_receipts.py', 'deploy/aws-feasibility/completion_campaign_state.py', 'scripts/stage2-production-approval.py', 'scripts/stage2-stage-production-approval.py', 'test/aws-stage2-completion-campaign-controller.py', 'test/aws-stage2-completion-campaign-controller.test.ts', 'test/aws-stage2-completion-campaign-aws-provider.py', 'test/aws-stage2-completion-campaign-aws-provider.test.ts', 'test/aws-stage2-completion-campaign-production.py', 'test/aws-stage2-completion-campaign-production.test.ts', 'test/aws-stage2-completion-campaign-receipts.py', 'test/aws-stage2-completion-campaign-receipts.test.ts')
...
def _product_test_budget(data, allocations):
    ...
    for task, expected_task in zip(tasks, PRODUCT_TEST_TASK_SPECS):
        ...
        if name == "aws_principal_denial_and_cycle_custody":
            expected_keys |= {"forecast_slices", "withheld_forecast", "ingress_inventory", "budget_consumers"}
