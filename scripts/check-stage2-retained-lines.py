...
PRODUCT_TEST_REMAINING_LINES, PRODUCT_TEST_REMAINING_BYTES = 24_918, 21_500_000
PRODUCT_TEST_GLOBAL_LINE_FORECAST, PRODUCT_TEST_GLOBAL_BYTE_FORECAST = 42_918, 29_500_000
...
def _remediation_budget():
    ...
    _require(data["source_limits"] == {"tracked_files": 1568,
    ...
    try:
        ...
        raise LineBudgetError() from None
    _require("MAXIMUM_TRACKED_FILES = 1568" in producer
