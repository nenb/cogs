...
PRODUCT_TEST_REMAINING_LINES, PRODUCT_TEST_REMAINING_BYTES = 21_557, 20_800_000
PRODUCT_TEST_GLOBAL_LINE_FORECAST, PRODUCT_TEST_GLOBAL_BYTE_FORECAST = 39_557, 28_800_000
...
def _product_test_budget(data, _allocations):
    """Validate the deliberately small ADR0338–ADR0342 task matrix.
