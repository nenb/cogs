...
PRODUCT_TEST_TASK_SPECS = (
    ('governance', 6000, 1100000, ('config/external-review-remediation-budget-v1.json', 'docs/adr/0338-plan-pre-h-final-corrections.md', 'docs/adr/0339-row4-first-attempt-corrections.md', 'docs/adr/0340-row4-second-minimal-correction-batch.md', 'docs/adr/README.md', 'scripts/check-stage2-retained-lines.py', 'test/stage2-remediation-budget.test.ts')),
