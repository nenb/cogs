...
PRODUCT_TEST_REMAINING_LINES, PRODUCT_TEST_REMAINING_BYTES = 25_062, 21_500_000
PRODUCT_TEST_GLOBAL_LINE_FORECAST, PRODUCT_TEST_GLOBAL_BYTE_FORECAST = 43_062, 29_500_000
...
SOURCE_INVENTORY = ROOT / "docs/security-evidence/stage4-offline-readiness-artifacts/source-inventory.json"
SOURCE_INVENTORY_PRODUCER = ROOT / "scripts/stage4-offline-source-inventory.ts"
PRODUCT_TEST_PENDING_READINESS_REGENERATIONS = 0
PRODUCT_TEST_PENDING_REGENERATION_LINE_COSTS = {"governance": 3, "product": 1, "readiness-ci": 3}
PRODUCT_TEST_TASK_SPECS = (
    ('governance', 8800, 1300000, ('.github/workflows/stage2-production-plan.yml', '.pi/outcome-two/adr0091-plan-ab.md', '.pi/outcome-two/adr0091-plan-cd.md', '.pi/outcome-two/adr0091-plan-common.md', '.pi/outcome-two/adr0091-plan-ei.md', '.pi/outcome-two/adr0091-plan-holistic.md', '.pi/outcome-two/adr0093-review-ab.md', '.pi/outcome-two/adr0093-review-auth.md', '.pi/outcome-two/adr0093-review-c.md', '.pi/outcome-two/adr0093-review-common.md', '.pi/outcome-two/adr0093-review-d.md', '.pi/outcome-two/adr0093-review-e.md', '.pi/outcome-two/adr0093-review-holistic.md', '.pi/outcome-two/adr0093-review-integration.md', '.pi/outcome-two/adr0093-review-portable.md', '.pi/outcome-two/adr0093-review-workflow.md', 'BUGS-TO-FIX.md', 'config/external-review-remediation-budget-v1.json', 'docs/adr/0338-plan-pre-h-final-corrections.md', 'docs/adr/0339-row4-first-attempt-corrections.md', 'docs/adr/0340-row4-second-minimal-correction-batch.md', 'docs/adr/0342-row4-fourth-minimal-correction-batch.md', 'docs/adr/0343-row4-fifth-minimal-correction-batch.md', 'docs/adr/0344-row4-proactive-confirmed-domain-batch.md', 'docs/adr/0345-row4-sixth-runtime-correction.md', 'docs/adr/0346-row4-post-merge-product-correction.md', 'docs/adr/0347-add-direct-kvm-diagnostic-lane.md', 'docs/adr/0348-retire-transient-H-producer.md', 'docs/adr/0351-correct-aws-host-boundaries-before-new-h.md', 'docs/adr/0368-correct-post-qualification-planning-control.md', 'docs/adr/0369-retire-failed-planning-and-align-expiry.md', 'docs/adr/README.md', 'docs/security-evidence/plans/stage2-prebuilt-completion-prerequisite-map.md', 'schemas/aws-stage2-completion-evidence-v3.json', 'schemas/aws-stage2-completion-evidence-v4.json', 'schemas/aws-stage2-completion-production-approval-draft-v4.json', 'schemas/aws-stage2-completion-production-approval-v5.json', 'schemas/aws-stage2-completion-production-approval-v6.json', 'schemas/aws-stage2-completion-publication-v2.json', 'schemas/aws-stage2-production-continuation-admission-v1.json', 'schemas/aws-stage2-production-continuation-v1.json', 'schemas/aws-stage2-production-evidence-upload-receipt-v3.json', 'scripts/check-stage2-retained-lines.py', 'scripts/render-aws-stage2-completion-report-v4.ts', 'scripts/stage2-production-approval.py', 'scripts/stage2-production-planner.py', 'scripts/validate-aws-stage2-completion-evidence-v4.ts', 'test/aws-stage2-completion-evidence-v4.test.ts', 'test/fixtures/stage2-completion/approval-v5-test-only.json', 'test/fixtures/stage2-completion/production-v4-test-only.md', 'test/stage2-production-approval.py', 'test/stage2-production-approval.test.ts', 'test/stage2-production-planner.py', 'test/stage2-production-planner.test.ts', 'test/stage2-production-workflows.test.ts', 'test/stage2-remediation-budget.test.ts')),
    ('product', 5059, 1950000, ('.github/workflows/insecure-container.yml', '.github/workflows/kvm-driver-diagnostic.yml', '.github/workflows/kvm-qualification.yml', '.github/workflows/release-images.yml', 'config/release-image-set-pins-v1.json', 'IMPLEMENTATION.md', 'biome.json', 'dev/linux-kvm/driver.sh', 'dev/linux-kvm/bounded-command.py', 'dev/linux-kvm/qualification-owner.py', 'dev/linux-kvm/qualify.sh', 'dev/product-test/host-custody.py', 'dev/product-test/runner.ts', 'dev/product-test/snapshot-owner.ts', 'docs/adr/0337-correct-protected-product-runtime-ancestry.md', 'docs/adr/0341-row4-third-minimal-correction-batch.md', 'docs/operations/release-image-publication.md', 'docs/operations/production-runtime-foundation.md', 'docs/operations/stage-4-offline-readiness.md', 'docs/security-evidence/release-image-set-assertion-34774398155.canonical.json', 'docs/security-evidence/release-image-set-review-34774398155.canonical.json', 'docs/security-evidence/stage4-offline-readiness-package.json', 'docs/test-reports/stage-4-offline-readiness.md', 'images/sandbox/entrypoint.sh', 'schemas/release-image-set-assertion-v1.json', 'schemas/release-image-set-review-v3.json', 'schemas/stage4-authenticated-runtime-artifact-evidence-v4.json', 'schemas/stage4-offline-readiness-package-v5.json', 'scripts/release-image-set-review-v2.ts', 'scripts/release-image-set-review-v3.ts', 'scripts/stage4-offline-readiness-regenerate.ts', 'src/egress/otlp-telemetry.ts', 'src/egress/runtime-manager.ts', 'src/runtime/compose.ts', 'src/skills/snapshot-session-preparer.ts', 'src/ssh/connection.ts', 'src/telemetry/otlp-http.ts', 'src/telemetry/worker-telemetry.ts', 'test/egress-otlp-telemetry.test.ts', 'test/egress-runtime-manager.test.ts', 'test/launcher-smoke-evidence.test.ts', 'test/linux-kvm-git-tools.test.ts', 'test/otlp-http.test.ts', 'test/ssh-connection.test.ts', 'test/worker-telemetry.test.ts', 'test/dev-launcher-profiles.test.ts', 'test/production-compose.test.ts', 'test/production-sandbox-image.test.ts', 'test/release-image-set-assertion.test.ts', 'test/aws-stage2-completion-final-integration-linux.test.ts', 'test/aws-stage2-completion-immutable-preparation.test.ts', 'test/release-image-set-review-v2.test.ts', 'test/release-image-set-review-v3.test.ts', 'test/stage4-offline-readiness.test.ts', 'test/stage4-runtime-artifact-closure.test.ts')),
    ('local-tofu-ssm', 6220, 2800000, ('.github/workflows/stage2-production-approval-signing-diagnostic.yml', '.github/workflows/stage2-production-approval.yml', '.github/workflows/stage2-production-campaign.yml', '.github/workflows/stage2-r-diagnostic-campaign.yml', '.github/workflows/stage2-r-diagnostic-preparation.yml', '.github/workflows/stage2-workload-linux-foundations.yml', 'deploy/aws-feasibility/check-plan.py', 'deploy/aws-feasibility/completion_campaign_aws_adapter.py', 'deploy/aws-feasibility/completion_campaign_aws_entry.py', 'deploy/aws-feasibility/completion_campaign_aws_provider.py', 'deploy/aws-feasibility/completion_campaign_controller.py', 'deploy/aws-feasibility/completion_campaign_evidence_issuer.py', 'deploy/aws-feasibility/completion_campaign_production.py', 'deploy/aws-feasibility/destroy.sh', 'deploy/aws-feasibility/main.tf', 'deploy/aws-feasibility/run-production-campaign.sh', 'scripts/stage2-cosign-keyless-sign.sh', 'scripts/stage2-stage-production-approval.py', 'test/aws-stage2-completion-campaign-aws-adapter.test.ts', 'test/aws-stage2-completion-campaign-aws-provider.py', 'test/aws-stage2-completion-campaign-aws-provider.test.ts', 'test/aws-stage2-completion-campaign-production.py', 'test/aws-stage2-completion-campaign-production.test.ts', 'test/aws-stage2-completion-campaign-remote-adapter.py')),
    ('readiness-ci', 289, 10750000, ('.gitleaksignore', '.github/workflows/ci.yml', 'docs/security-evidence/stage4-offline-readiness-artifacts/authenticated-runtime-artifacts.json', 'docs/security-evidence/stage4-offline-readiness-artifacts/image-lock.json', 'docs/security-evidence/stage4-offline-readiness-artifacts/schema-inventory.json', 'docs/security-evidence/stage4-offline-readiness-artifacts/source-inventory.json', 'docs/security-evidence/stage5-destructive-harness-report.canonical-json', 'scripts/stage4-offline-readiness.ts', 'scripts/stage4-offline-source-inventory.ts', 'scripts/stage4-runtime-artifact-closure.ts', 'test/ci-infrastructure-boundary.test.ts')),
    ('final-HGQ', 4694, 4700000, ('.github/workflows/stage2-local-static-control-prebuilt-candidate.yml', '.github/workflows/stage2-prebuilt-kvm-integration-diagnostic.yml', '.github/workflows/stage2-prebuilt-kvm-rehearsal.yml', '.github/workflows/stage2-prebuilt-local-kata-qualification.yml', '.github/workflows/stage2-prebuilt-mixed-hg-preflight.yml', '.github/workflows/stage2-prebuilt-rootfs-diagnostic-producer.yml', '.github/workflows/stage2-prebuilt-rootfs-diagnostic-publisher.yml', '.github/workflows/stage2-prebuilt-rootfs-producer.yml', '.github/workflows/stage2-prebuilt-rootfs-publisher.yml', 'config/stage2-retired-revisions-v2.json', 'config/stage2-retired-revisions-v3.json', 'config/stage2-retired-revisions-v4.json', 'config/stage2-retired-revisions-v5.json', 'config/stage2-retired-revisions-v6.json', 'config/stage2-retired-revisions-v7.json', 'config/stage2-retired-revisions-v8.json', 'deploy/aws-feasibility/remote/completion_kata_admission.py', 'deploy/aws-feasibility/remote/completion_kata_preparation.py', 'deploy/aws-feasibility/remote/completion_kata_process.py', 'deploy/aws-feasibility/remote/recover-stage2-completion-remote.sh', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/00-ip.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/01-tc.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/02-nft.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/03-ssh.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/04-ssh-keygen.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/05-containerd.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/06-ctr.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/07-shim.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/08-qemu.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/contracts/09-virtiofsd.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/stage2-local-execution-envelope-v3.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/stage2-local-execution-envelope-v4.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/stage2-local-runtime-manifest-v3.json', 'deploy/aws-feasibility/remote/stage2-completion-local-control-v7/stage2-local-static-control-v2.json', 'docs/adr/0349-freeze-replacement-H-and-authorize-control.md', 'docs/adr/0350-establish-replacement-Q-and-authorize-qualification.md', 'docs/adr/0352-freeze-fresh-H-and-authorize-G-control.md', 'docs/adr/0353-retire-failed-static-generation-and-correct-workflow-binding.md', 'docs/adr/0354-correct-protected-timeout-tests-before-control.md', 'docs/adr/0355-freeze-timeout-corrected-H-and-authorize-control.md', 'docs/adr/0356-establish-timeout-corrected-Q-and-authorize-qualification.md', 'docs/adr/0357-retire-failed-qualification-and-scope-host-local-observations.md', 'docs/adr/0358-freeze-host-scoped-H-and-authorize-control.md', 'docs/adr/0359-establish-host-scoped-Q-and-authorize-qualification.md', 'docs/adr/0360-retire-runner-image-rejected-generation.md', 'docs/adr/0361-freeze-authenticated-runner-H-and-authorize-control.md', 'docs/adr/0362-establish-authenticated-runner-Q-and-authorize-qualification.md', 'docs/adr/0363-retire-cross-rollout-preflight-and-bind-assigned-host-closures.md', 'docs/adr/0364-retire-stale-Q-bindings-and-require-complete-static-handoff.md', 'docs/adr/0365-retire-premature-producer-and-require-replacement-H.md', 'docs/adr/0366-freeze-replacement-H-and-authorize-control.md', 'docs/adr/0367-establish-replacement-Q-and-authorize-qualification.md', 'docs/security-evidence/stage4-offline-readiness-artifacts/local-validation.json', 'schemas/stage2-formal-local-cycle-status-v3.json', 'schemas/stage2-local-execution-envelope-v4.json', 'schemas/stage2-pre-aws-qualification-package-v6.json', 'scripts/stage2-formal-local-qualification.py', 'scripts/stage2-prebuilt-local-qualification-guard.py', 'scripts/stage2-prebuilt-mixed-hg-preflight.sh', 'scripts/stage2-prebuilt-static-control-runtime-boundary.py', 'scripts/stage2-revision-retirement.py', 'scripts/stage2-stage-prebuilt-control.py', 'test/aws-stage2-completion-kata-mutable-bridges.test.ts', 'test/aws-stage2-completion-kata-process.py', 'test/aws-stage2-completion-kata-runtime.py', 'test/aws-stage2-completion-kata-runtime.test.ts', 'test/aws-stage2-completion-kata-static-control.py', 'test/aws-stage2-completion-kata-static-control.test.ts', 'test/aws-stage2-completion-local-result.py', 'test/aws-stage2-completion-local-result.test.ts', 'test/fixtures/stage2-completion/production-v4-test-only.json', 'test/stage2-formal-local-qualification.py', 'test/stage2-formal-local-qualification.test.ts', 'test/stage2-local-static-control-candidate-workflow.test.ts', 'test/stage2-local-workflow-scripts.py', 'test/stage2-prebuilt-kvm-integration-diagnostic.test.ts', 'test/stage2-prebuilt-local-kata-workflow.test.ts', 'test/stage2-prebuilt-local-static-control-workflow.test.ts', 'test/stage2-prebuilt-rehearsal-grant.py', 'test/stage2-prebuilt-static-control-runtime-boundary.py')),
)
PRODUCT_TEST_TASK_PATHS = {name: paths for name, _lines, _bytes, paths in PRODUCT_TEST_TASK_SPECS}
PRODUCT_TEST_TASK_MAXIMA = {name: (lines, raw_bytes) for name, lines, raw_bytes, _paths in PRODUCT_TEST_TASK_SPECS}
PRODUCT_TEST_FINAL_H_REVISION = "5ea2064daa3e62ddbd68fc0f0bb20db1eb0c3f3c"
PRODUCT_TEST_FINAL_H_PARENT = "ede3c228eea1efb4cd3a435b969f59aeb7f71c10"
PRODUCT_TEST_FINAL_H_TREE = "b8734d91e693a01a29d49a9a4d5f9eb3843ad374"
PRODUCT_TEST_FINAL_HGQ_PRE_H_CAP = (604, 1_700_000)
PRODUCT_TEST_FINAL_HGQ_POST_H_CAP = (4_090, 3_000_000)
...
FINAL_CONTROL_DATA_MEMBERS = (
    *(f"{FINAL_CONTROL_DATA_ROOT}/contracts/{index:02d}-{role}.json" for index, role in enumerate((
        "ip", "tc", "nft", "ssh", "ssh-keygen", "containerd", "ctr", "shim", "qemu", "virtiofsd"))),
    *(f"{FINAL_CONTROL_DATA_ROOT}/stage2-local-{name}-v{4 if name == 'execution-envelope' else 3}.json" for name in (
...
ADR0349_RETAINED_FILES = ("config/stage2-retired-revisions-v2.json",)
ADR0353_RETAINED_FILES = ("config/stage2-retired-revisions-v3.json",)
ADR0357_RETAINED_FILES = ("config/stage2-retired-revisions-v4.json",)
RETAINED_FILES = (
    *ADR0327_RETAINED_FILES,
    *ADR0330_RETAINED_FILES,
    *ADR0349_RETAINED_FILES,
    *ADR0353_RETAINED_FILES,
    *ADR0357_RETAINED_FILES,
...
def _remediation_budget():
    ...
    _require(data["source_limits"] == {"tracked_files": 1569,
    ...
    try:
        ...
        raise LineBudgetError() from None
    _require("MAXIMUM_TRACKED_FILES = 1569" in producer
...
def _product_test_budget(data, _allocations):
    """Validate the deliberately small ADR0338–ADR0366 task matrix.
    ...
    for task, (name, lines, raw_bytes, paths) in zip(tranche["allocations"], PRODUCT_TEST_TASK_SPECS):
        ...
        seen.update(paths)
        if name == "final-HGQ":
            _require(task["pre_h_cap"] == {"gross_lines": 604, "gross_bytes": 1700000}
                     and task["post_h_reserve"] == {"gross_lines": 4090, "gross_bytes": 3000000}
...
def _product_test_linear_commits(base, head):
    merges = _git(["rev-list", "--min-parents=2", base + ".." + head]).splitlines()
    _require(not merges)
    commits = _git(["rev-list", "--reverse", base + ".." + head]).splitlines()
    parent = base
...
def _product_test_segment(base, head, include_worktree):
    allowed = set().union(*(set(paths) for paths in PRODUCT_TEST_TASK_PATHS.values()))
    lines = {name: 0 for name in PRODUCT_TEST_TASK_PATHS}; raw_bytes = dict(lines)
...
def _enforce_product_test_consumption(pre_lines, pre_bytes, post_lines, post_bytes):
    names = set(PRODUCT_TEST_TASK_MAXIMA)
    _require(all(set(values) == names for values in (pre_lines, pre_bytes, post_lines, post_bytes)))
    lines = {name: pre_lines[name] + post_lines[name] for name in names}
    raw_bytes = {name: pre_bytes[name] + post_bytes[name] for name in names}
    _require(all(type(value) is int and value >= 0
                 for values in (pre_lines, pre_bytes, post_lines, post_bytes)
                 for value in values.values()))
    for name, cap in PRODUCT_TEST_TASK_MAXIMA.items():
        _require(lines[name] <= cap[0] and raw_bytes[name] <= cap[1])
    _require(pre_lines["final-HGQ"] <= PRODUCT_TEST_FINAL_HGQ_PRE_H_CAP[0]
             and pre_bytes["final-HGQ"] <= PRODUCT_TEST_FINAL_HGQ_PRE_H_CAP[1]
             and post_lines["final-HGQ"] <= PRODUCT_TEST_FINAL_HGQ_POST_H_CAP[0]
             and post_bytes["final-HGQ"] <= PRODUCT_TEST_FINAL_HGQ_POST_H_CAP[1])
    _require(sum(lines.values()) <= PRODUCT_TEST_REMAINING_LINES
             and sum(raw_bytes.values()) <= PRODUCT_TEST_REMAINING_BYTES)
    return lines, raw_bytes
...
def _product_test_consumption_segments(budget):
    ...
    _require(re.fullmatch(r"[0-9a-f]{40}", head) is not None
             and _git(["rev-parse", PRODUCT_TEST_FINAL_H_REVISION + "^{tree}"]).strip() == PRODUCT_TEST_FINAL_H_TREE
    ...
    _serialized_inventory_within_limit(source_inventory)
    _require(all(lines[name] + PRODUCT_TEST_PENDING_READINESS_REGENERATIONS * cost
                 <= PRODUCT_TEST_TASK_MAXIMA[name][0] for name, cost in PRODUCT_TEST_PENDING_REGENERATION_LINE_COSTS.items())
             and raw_bytes["readiness-ci"] + PRODUCT_TEST_PENDING_READINESS_REGENERATIONS * len(source_inventory)
             <= PRODUCT_TEST_TASK_MAXIMA["readiness-ci"][1])
    return lines, raw_bytes, pre_lines, pre_bytes, post_lines, post_bytes


def _product_test_consumption(budget):
    lines, raw_bytes, *_segments = _product_test_consumption_segments(budget)
    return lines, raw_bytes
...
def measure():
    ...
    _require(tracked_names | ordinary_names == retained_names
             and ordinary_names <= set((*ADR0327_RETAINED_FILES, *ADR0330_RETAINED_FILES, *ADR0349_RETAINED_FILES, *ADR0353_RETAINED_FILES, *ADR0357_RETAINED_FILES)))
    ...
    report = {
        ...
        "product_test_final_h_revision": PRODUCT_TEST_FINAL_H_REVISION,
        "product_test_final_h_tree": PRODUCT_TEST_FINAL_H_TREE,
        "product_test_task_gross_added_lines": product_test_task_lines,
        "product_test_task_line_maxima": {name: limits[0] for name, limits in PRODUCT_TEST_TASK_MAXIMA.items()},
        "product_test_task_gross_added_line_bytes": product_test_task_bytes,
        "product_test_task_byte_maxima": {name: limits[1] for name, limits in PRODUCT_TEST_TASK_MAXIMA.items()},
        "product_test_task_remaining_lines": {name: PRODUCT_TEST_TASK_MAXIMA[name][0] - product_test_task_lines[name] for name in product_test_task_lines},
        "product_test_task_remaining_line_bytes": {name: PRODUCT_TEST_TASK_MAXIMA[name][1] - product_test_task_bytes[name] for name in product_test_task_bytes},
        "product_test_final_hgq_pre_h_consumption": {"lines": product_test_pre_h_lines["final-HGQ"], "bytes": product_test_pre_h_bytes["final-HGQ"]},
        "product_test_final_hgq_pre_h_cap": {"lines": PRODUCT_TEST_FINAL_HGQ_PRE_H_CAP[0], "bytes": PRODUCT_TEST_FINAL_HGQ_PRE_H_CAP[1]},
        "product_test_final_hgq_post_h_consumption": {"lines": product_test_post_h_lines["final-HGQ"], "bytes": product_test_post_h_bytes["final-HGQ"]},
        "product_test_final_hgq_post_h_cap": {"lines": PRODUCT_TEST_FINAL_HGQ_POST_H_CAP[0], "bytes": PRODUCT_TEST_FINAL_HGQ_POST_H_CAP[1]},
