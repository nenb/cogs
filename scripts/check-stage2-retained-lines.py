...
PRODUCT_TEST_FORECASTS = {"route": 0, "revocation": 0, "relay": 2_800,
                          "lifecycle": 4_450, "completion": 2_900, "integration": 5_387}
PRODUCT_TEST_BYTE_FORECASTS = {"route": 0, "revocation": 0, "relay": 400_000,
                               "lifecycle": 450_000, "completion": 300_000, "integration": 2_600_000}
REMEDIATION_BYTE_HIGHS = {"route": 350_000, "revocation": 220_000, "relay": 700_000,
                         "lifecycle": 1_200_000, "completion": 800_000, "integration": 3_950_000}
PRODUCT_TEST_GLOBAL_BYTE_FORECAST = 3_250_000
...
def _remediation_budget():
    ...
    expected = {"route": 2_200, "revocation": 3_000, "relay": 4_800,
                "lifecycle": 11_800, "completion": 6_400, "integration": 17_712}
    owners = {}
    paths = {}
    new_file_highs = {}
    forecasts = {}
    ...
    _require(sum(new_file_highs.values()) == 97
             and sum(forecast["total"] for forecast in forecasts.values()) == 7_220_000)
...
def _product_test_budget(data, allocations):
    ...
    _require(plan["base_revision"] == PRODUCT_TEST_Q and plan["base_tree"] == PRODUCT_TEST_Q_TREE
             ...
             and plan["integration_regeneration_gross_line_forecast"] == 200 and type(plan["integration_synchronization_gross_byte_forecast"]) is int and plan["integration_synchronization_gross_byte_forecast"] == 60_000)
