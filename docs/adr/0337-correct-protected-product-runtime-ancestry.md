...
Fund one final `3,000/3,000,000` tranche: runtime correction/tests `1,000/1,000,000`; future H/G/Q control/evidence `2,000/2,000,000`. Product global is `21,000/11,000,000`; remediation global is `52,000/14,000,000`; source aggregate ceiling is `34,000,000`. Retained-plus-consumed tranche lines and bytes admit the exact global boundary (`<=`); only an overage fails. The `115,000` hard line limit is unchanged. Future H/G/Q remains separately authorized and unexecuted.
