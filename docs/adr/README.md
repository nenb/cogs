...
ADRs 0001–0010 were accepted by Nick Byrne on 2026-07-10. ADR 0011 was accepted at the Stage 1 proxy-selection gate on 2026-07-14. ADR 0012 was accepted by Nick Byrne for the Stage 2 AWS runtime decision on 2026-07-14. ADR 0013 was accepted by Nick Byrne for the issue #64 SSH bash line-budget exception on 2026-07-15. ADR 0014 is proposed for the issue #65 model-auth scope and line-budget gate.
...
| [0014](0014-model-auth-api-keys-and-disabled-oauth-broker.md) | Issue #65 model-auth scope and line budget | Proposed |
