...
Measured workflow gross additions rise from 1,124 to 1,183 lines. Raise only the workflow correction high from 1,150 to 1,250. Global correction remains below 11,000 and conservative total remains below the 67,000 hard stop.
