...
A second bounded refresh on 2026-09-13 selected OS database `ghcr.io/aquasecurity/trivy-db:2@sha256:bf4e0ac6ba84af6985086f394f50849a0d59b52110706b1d4ba946df91e433d7` (`UpdatedAt=2026-09-13T13:10:01.590129293Z`, `NextUpdate=2026-09-14T13:10:01.590129203Z`) and Java database `ghcr.io/aquasecurity/trivy-java-db:1@sha256:b19c281ec798816f854d5f875a132563117c5c5dd905be42ca3600aa8a6d1dc3` (`UpdatedAt=2026-09-13T01:12:19.368599386Z`, `NextUpdate=2026-09-16T01:12:19.368599236Z`). Their exact manifest digests, schema `2`, artifact type, sole layer media types, metadata versions `2`/`1`, and more-than-60-minute exclusive validity were verified with the pinned Trivy image. This refresh has the same bounded, non-authorizing semantics as the table above.
