...
Readiness v3 binds the successful protected-main assertion SHA-256 `ad45d6b0a114c481eb869daff38f4ddc669801e8a5b5d808c404b506ae33c450`, independent review SHA-256 `f6a607349062f5ca9211978600012b4cd16651af984c083a0329646a74da6a3a`, workflow run `30852317459`, image-source revision `d3ddb987ceeec0bae0fa2d89fdc134187a0d1de3`, and both exact GHCR digest references. The image source is deliberately separate from the later readiness-source worktree closure; this prevents metadata-only readiness revisions from falsely claiming to be the bytes that built the images or requiring a circular republication. `release_image_set_present=true` and static image identity closure is complete, so `RELEASE_IMAGE_SET_ABSENT` is removed.
