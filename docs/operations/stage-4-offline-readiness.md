...
## Current governance boundary (ADR 0330)
...
ADR 0330 extends ADR 0326's closed typed exact-selection registry through the runner-rollover generation: 27 revisions, 33 runs, and 23 artifacts. The canonical JSON, independent Python copy, and all current pre-effect workflow mirrors contain the same revision, run, and artifact identities. Tests derive mirror equality from the canonical policy and independently require the historical H3/G3/Q3 tuple, its custody, and the newest retired producer generation to be rejected before effects.
...
Readiness v5 binds protected-main assertion SHA-256 `ffbfd017d6a2c4512beb5b9452a6cbc69ebb20a90c97716f2f35003a78154332`, independent review SHA-256 `f4a6f55642c9ed035d77ca409a2e823e5dcce14bdc35050b8459c384e7b381d4`, workflow run `34774398155`, image-source revision `371cfa58a90888d12d6ae5a857275323ab3f43c4`, and exact Pi 0.84.2 worker/sandbox GHCR digests. `release_image_set_present=true`, static image identity closure is satisfied, and `RELEASE_IMAGE_SET_ABSENT` is removed. Readiness v4 and runs `30852317459`/`31856469035` retain their historical meanings.
