...
test("event-contract replacement guard is exact source and precedes every source effect", () => {
  ...
  assert.match(dispatchGuard, /GUARD_VERSION = "cogs\.stage2-static-control-dispatch-guard\/v5"/u);
  ...
  assert.match(dispatchGuard, /REVIEWED_IMPLEMENTATION_HEAD = "01de769a43d69f1a8b47b20c5f4506219abb2f9c"/u);
...
test("static-only cleanup uses reviewed source policy and owned process-fd censuses", () => {
  ...
  assert.match(runtimeBoundary, /NORMALIZED_WORKFLOW_SHA256 = "6376cbc20b5b1507dd33bf634bf7ccb60c4d56b6ef60d098c195ffc71d85ee3c"/u);
