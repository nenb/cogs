...
test("event-contract replacement guard is exact source and precedes every source effect", () => {
  ...
  assert.match(dispatchGuard, /REVIEWED_IMPLEMENTATION_HEAD = "89243c8d9f7a946aefdaa4c445a5cfe1e0fe7e14"/u);
...
test("static-only cleanup uses reviewed source policy and owned process-fd censuses", () => {
  ...
  assert.match(
    runtimeBoundary,
    /NORMALIZED_WORKFLOW_SHA256 = "f6c567e09a16e350e5d41cca1666efa06bf29d4cc8c7ae1db2bd2b241a4c9a14"/u,
  );
