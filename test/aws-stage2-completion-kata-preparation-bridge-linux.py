...
def make_tree(base):
    ...
    # Production cleanup runs as root. Keep this unprivileged Linux descriptor/fault
    # harness writable while preserving the exact executable generations.
    os.chmod(binary, 0o700); os.chmod(runtime, 0o700)
