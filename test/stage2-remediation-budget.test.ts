...
test("ADR0338 through ADR0346 retain the five literal tasks and final reserve", () => {
  runPython(`
...
assert [(t['gross_lines'],t['gross_bytes']) for t in tasks] == [(5800,1100000),(4800,3200000),(4457,8400000),(1800,3300000),(5300,5500000)]
