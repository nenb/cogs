...
assert [(t['gross_lines'],t['gross_bytes']) for t in tasks] == [(6200,1100000),(5057,2900000),(5100,3300000),(500,8700000),(5300,5500000)]
...
assert tasks[2]['gross_lines'] == 5100 and tasks[2]['gross_bytes'] == 3300000
assert tasks[3]['gross_lines'] == 500 and tasks[3]['gross_bytes'] == 8700000
