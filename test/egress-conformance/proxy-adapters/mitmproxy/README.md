...
The latest upstream image currently has six fixed HIGH findings. `.trivyignore-mitmproxy` records their narrow test-only scope, evidence, owner, issue #25 tracking, and automatic expiry on 2026-07-27. The findings remain visible in scan logs and are a candidate-comparison disadvantage; the exception cannot support selection or release.
