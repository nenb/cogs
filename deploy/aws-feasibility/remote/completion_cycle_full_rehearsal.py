#!/usr/bin/env python3
"""Zero-argument real full-route rehearsal with no receipt issuance."""
import os
...
def main():
    if sys.argv != [sys.argv[0]]:
        raise SystemExit(64)
    if coordinator._run_fixed_full_rehearsal() is not None:
        raise SystemExit(70)
    os.write(1, b"cogs-stage2-full-rehearsal-pass\n")
