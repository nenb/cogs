#!/usr/bin/env python3
"""Zero-argument non-cloud formal readiness-cycle owner entry."""
import os
from pathlib import Path
import sys

_DIAGNOSTIC = b"stage2-formal-cycle-readiness: owner.failed\n"
...
def main():
    raw = evidence._consume_cycle_receipt(coordinator._run_formal_local_readiness_cycle())
    offset = 0
